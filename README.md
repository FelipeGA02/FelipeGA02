...
![Matplotlib](https://img.shields.io/badge/Matplotlib-31326F?style=for-the-badge&logo=python&logoColor=white)
...
> `Analytics Engineering` • `ETL/ELT Pipelines` • `Financial Data Processing` • `Microservices Architecture` • `Scrum/Kanban` • `Computer Vision`
